...
const images = [
  ...
  {
    url: 'https://images.unsplash.com/photo-1600880292089-90a7e086ee0d?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80',
    title: 'Office Cleaning Services',
    description: 'Maintain a professional and healthy work environment',
  },
  {
    url: 'https://images.unsplash.com/photo-1600880292254-2a5f11b72130?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80',
    title: 'Residential Cleaning',
    description: 'Quality cleaning solutions for your home',
  },
  {
    url: 'https://images.unsplash.com/photo-1600880292239-27d18093483d?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80',
