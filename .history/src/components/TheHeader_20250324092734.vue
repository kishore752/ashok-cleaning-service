  ...
  <header class="header">
    <div class="header-content">
      ...
      <nav class="nav-desktop">
        ...
        <div class="nav-dropdown" :class="{ 'is-open': isDropdownOpen }">
          <button class="nav-dropdown-button" @click="toggleDropdown">
            Services
          ...
          <div class="nav-dropdown-menu">
            <RouterLink
              ...
              @click="selectOption(service.title)"
            >
              {{ service.title }}
            </RouterLink>
          </div>
...
const services = [
  ...
  { id: 'post-construction', title: 'Post-Construction Cleaning' },
